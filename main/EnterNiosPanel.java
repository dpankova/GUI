...
public class EnterNiosPanel extends JPanel{
  ...
  public EnterNiosPanel(JFrame gui, MyProcess myprocess, JMenu menu,  
			...
			Map<Integer, Component> map, JTextArea ta_main)
    {
      ...
      add(b_enter_nios,"cell 1 0, width 130:130:130, height 25:25:25, align, center, grow 0");
      add(b_sel_shell, "cell 1 1, width 50:50:50, height 25:25:25, align center, grow 0");
      add(sp_shell,"cell 0 1, width 100:800:800, height 35:35:35, growx");
      add(l_shell,"cell 0 0, width 100:130:130, height 10:25:25, grow 0");
      add(b_exit, "cell 0 2 2 1 , width 150:150:150, height 25:25:25,  align, center, grow 0");
      
      map.put(199,b_enter_nios);
