...
//------------------------  processes start here  --------------------------------
    ...
    else
    {
      myprocess.setOutput();
      myprocess.setInput();
      ThreadStart reader = new ThreadStart(myprocess,this,que);
    ...
    ServicePanel panel_ser = new ServicePanel(this, myprocess, myprocess_firm, menu_h, mapDisableMain);
    ...
    EnterNiosPanel panel_enterN= new EnterNiosPanel(this, myprocess, menu_m, ta_shell, b_exit, mapDisableMain, ta_main);
